...
} = require('../commands/infos/respostas'); // Ajuste o caminho conforme sua estrutura!
 ...
 * @param {string} text - The text of the message (cleaned).
 */
async function handerInfos(sock, msg, text) {
...
module.exports = { handerInfos }; // Exporta para ser usado no seu arquivo principal
